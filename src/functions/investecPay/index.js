...
import { openBrowser, goto, write, into, textBox, click, checkBox, dropDown, closeBrowser, waitFor, scrollDown } from 'taiko';
/**
...
export async function investecPay(req, res) {  
   ...
   try {
        ...
        await goto("https://login.secure.investec.com/pc-za/payments-sa/payment-method/make-payment/onceoff", {waitForNavigation: false});	
